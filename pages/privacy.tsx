    ...
    return <DocumentLayout title={"개인정보 처리 방침"}>
        <>
            <p>
                    ...
                    나쁜말카운터('https://chuyong.kr/' 이하 '나쁜말카운터')
            ...
            <ul className="list_indent2 mgt10">
                ...
                <li>필수항목 : 로그인ID, 이메일, 접속 로그, 서비스 이용 기록</li>
            </ul>
            <br/>
            <p className="lh6 bs4">
                <strong>
                ...
                <p>
                    <br/>① &lt;나쁜말카운터&gt;은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
                    ...
                    1. 파기절차
                    <br/>
                    &lt;나쁜말카운터&gt; 은(는) 파기 사유가 발생한 개인정보를 선정하고,
                    &lt;나쁜말카운터&gt;의 개인정보 보호책임자의 승인을 받아 개인정보를
                    파기합니다.
                    <br/>
                </p>
                ...
                <p>
                    <br/>
                    <br/>① 정보주체는 나쁜말카운터에 대해 언제든지 개인정보
                    열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
                </p>
                <p>
                    ② 제1항에 따른 권리 행사는나쁜말카운터에 대해 「개인정보 보호법」 시행령
                    제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
                    있으며 나쁜말카운터은(는) 이에 대해 지체 없이 조치하겠습니다.
                </p>
                <p>
                ...
                <p>
                    ⑥ 나쁜말카운터은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
                ...
                <p>
                    ① 나쁜말카운터 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해
                ...
                <p className="lh6 bs4">
                    <strong>제8조(가명정보를 처리하는 경우 가명정보 처리에 관한 사항)</strong>
                    ...
                    <p className="sub_p mgt10">
                        ① <span className="colorLightBlue">나쁜말카운터</span>
                    ...
                    <p>
                        ② 정보주체께서는 나쁜말카운터 의 서비스(또는 사업)을 이용하시면서 발생한
                        모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
                        개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 나쁜말카운터 은(는)
                    ...
                    <p className="sub_p mgt30">
                        <strong>
                            ...
                            아래의 부서에 할 수 있습니다.
                            <br/>
                            &lt;나쁜말카운터&gt; 은(는) 정보주체의 개인정보 열람청구가 신속하게
                            처리되도록 노력하겠습니다.{" "}
                        </strong>
                    </p>
                    <ul className="list_indent2 mgt10">
                    ...
                    <p/>
                    <p>
                        ① 이 개인정보처리방침은 2023년 6월 10부터 적용됩니다.
                    </p>
                    <p/>
