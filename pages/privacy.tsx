    ...
    return <DocumentLayout title={"개인정보 처리 방침"}>
        <>
            ...
            <p className="ls2">
                ...
                <em className="emphasis">6</em>월 <em className="emphasis">10</em>
                부터 적용됩니다.
            </p>
            <br />
            <p className="lh6 bs4">
            ...
            <p className="lh6 bs4">
                <strong>
                    제4조(개인정보의 파기절차 및 파기방법)<em className="emphasis"></em>
                </strong>
                <em className="emphasis"></em>
            </p>
            <em className="emphasis">
                <p className="ls2">
                    <br />① &lt;베어어스&gt;은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
                    ...
                    1. 파기절차
                    <br />
                    &lt;베어어스&gt; 은(는) 파기 사유가 발생한 개인정보를 선정하고,
                ...
                <p className="sub_p mgt10">
                    ...
                    4. 해킹 등에 대비한 기술적 대책
                    <br />
                    &lt;<em className="emphasis">베어어스</em>
                    &gt;('<em className="emphasis">나쁜말카운터</em>
                ...
                <p className="ls2">
                    <br />
                    <br />① 베어어스 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해
                ...
                <em className="emphasis">
                    ...
                    <p className="sub_p mgt10">
                        ① <span className="colorLightBlue">베어어스</span>
                    ...
                    <p className="sub_p">
                        ...
                        개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 베어어스 은(는)
